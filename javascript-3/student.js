...
//number of groceries in your groceries array using .length. Using an if/else statement, check if the number 
//of groceries is greater than or equal to 5. If it is, return the string 'That looks like a big trip' from the function. 
