...
var total = myNumbers.reduce((acc, el) => acc += el)
...
var forTheLoveOfGeorge = notGeorge.map(el => {
	if(el !== 'George'){
		return 'George'
	}
})
...
var totallyAwesome = people.reduce((acc, el) => {
